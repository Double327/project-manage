    ...
    <el-card>
      ...
      <div>
        ...
        <el-table :data="list" v-loading="loading" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="学院" width="120px" align="center" prop="college"/>
...
import {addUser, deleteUser, editUser, getTeacherList} from "@/api/system/user";
        ...
        if (valid) {
          ...
          if (this.form.id !== undefined) {
            ...
            addUser(this.form).then(() => {
              this.msgSuccess(this.form.name + '教师添加成功!');
              this.open = false;
              this.getList();
            });
          }
